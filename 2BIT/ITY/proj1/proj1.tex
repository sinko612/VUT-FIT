...
\usepackage[text={18cm, 24.7cm},left=1.6cm, top=1.5cm]{geometry}
...
\author{Simona Jánošíková \\ \href{mailto:xjanos19@stud.fit.vutbr.cz}{xjanos19@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
    Čím více \texttt{druhů}, \emph{řezů}, {\tiny velikostí}, {\color{green} barev} písma a~{\textsc{\color{blue} jiných efektů}} \underline{použijeme}, {\color{red}tím profesionálněji} bude \emph{dokument} vypadat.
...
Sekce \ref{sekcia2} a~\ref{sekcia3} obsahují typografické chyby.
